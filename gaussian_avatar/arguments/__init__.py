...
class DataParams(ParamGroup):
    def __init__(self, parser, sentinel=False):
        ...
        self.cam_static = True  # Whether to use static camera
        
        # Data processing parameters
        self.image_size = [1024, 1024]  # Image size
        self.num_workers = 4  # Number of data loading threads
        self.batch_size = 1  # Batch size
        self.shuffle = True  # Whether to shuffle data
        ...
        # Cache parameters
        self.cache_size = 0  # Cache size, 0 means no caching
        self.preload = False  # Whether to preload data
