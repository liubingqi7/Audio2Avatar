...
class Scene:
    ...
    def __init__(self, args : DataParams, gaussians : Union[GaussianModel, SMPLGaussianModel], load_iteration=None, shuffle=True, resolution_scales=[1.0]):
        """b
        ...
        if os.path.exists(os.path.join(args.source_path, "train")):
            scene_info = sceneLoadTypeCallbacks["MonoDataset"](args.source_path, args.white_background, args.eval)
        else:
